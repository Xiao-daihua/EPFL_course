...
\thm{
  ...
  \begin{align}
    \Psi_k^{scatt}(\mathbf{r})=\sum_{l=0}^\infty i^l\sqrt{4\pi(2l+1)}\tilde{\varphi}_{kl0}(\mathbf{r}).
  \end{align}
}
...
\begin{align}
  \Psi_k^{scatt}(\mathbf{r})\operatorname*{\sim}_{r\to\infty}-\sum_{l=0}^{\infty} i^{\,l}\sqrt{4\pi(2l+1)}\,Y_l^{0}(\theta)
\left[
...
\thm{
  ...
  \begin{align}
\Psi_k^{scatt}(\mathbf{r}) \operatorname*{\sim}_{r\to\infty} e^{ikz} + f_k(\theta)\frac{e^{ikr}}{r}
  \end{align}
其中：
\begin{align}
