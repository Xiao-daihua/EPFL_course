...
\end{enumerate}
\rmk{
半正定相对于不存在非负本征值还有一个等价的描述是：对于任意的态$ |\psi\rangle $，我们有$ \langle \psi | \rho | \psi \rangle \geq 0 $。
}
...
\end{itemize}
\rmk{对于量子态的制备，其实更一般的我们可以使用complete depolarizing channel进行定义，毕竟他完全抹除了输入态的信息，然后生成一个固定的态。}
