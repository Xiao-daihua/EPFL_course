...
\begin{itemize}
  ...
  \item Hermite条件保证Matrix Norm为：
    ...
    \end{align}
\end{itemize}
我们知道如果我们希望$ \tr (M H) $最大化，根据POVM的条件($ 0\leq M\leq I $)，我们知道，最大化的$ M
$应该是$ H_+ $对应的本征子空间的投影算子。也就是说：
\begin{align}
  M=\sum_{\lambda_i\geq0}|i\rangle\langle i|.
\end{align}
因此我们有：
\begin{align}
...
\end{align}
\rmk{注意任何矩阵$ A^\dagger A $的本征值都是非负实数！！也就是说奇异值也是非负实数！！这也保证了Schatten
p-Norm的定义是良好的！！}
