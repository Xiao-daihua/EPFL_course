...
我们考虑区分两个纯态$ |\psi_0\rangle $以及$ |\psi_1\rangle $。我们不妨构建一个POVM保证$ M_0
...
\thm{
  ...
  \begin{align}
    ...
    a\in\left[0,1/\left(1+\left\|\boldsymbol{\vec{x}}\right\|^2\right)\right]
  \end{align}
}
...
\begin{align}
  \frac{1}{2}\|\rho_0-\rho_1\|_1=\max_{0\leq M\leq
...
\begin{align}
  \begin{aligned}\left\|\rho_0-\rho_1\right\|_2&=\sqrt{\mathrm{Tr}((\rho_0-\rho_1)(\rho_0-\rho_1))}\\&=\sqrt{\mathrm{Tr}(\rho_0^2)+\mathrm{Tr}(\rho_1^2)-2\mathrm{~Tr}(\rho_0\rho_1)}.
  \end{aligned}
\end{align}
其中的信息可以通过SWAP测试来获得。
\begin{align}
