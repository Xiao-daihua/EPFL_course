...
\begin{abstract}
  这是EPFL 2025秋季学期的QI的课程笔记。主要涵盖QI的基础知识，POVM Measurement, Quantum Channel, Shot Noise, Entropy, Entanglement Resource Theory等内容。
\end{abstract}
...
\newpage 
\section{Lecture 10-11: Entropy and Fidelity}\label{sec:Lecture 10: Entropy} % (fold)
\input{lec10.tex}
% section Lecture 10: Entropy (end)

\newpage
\section{Lecture 12: Resouce Theory and Entanglement Resource}\label{sec:Lecture 11: Resouce Theory and Entanglement Resource} % (fold)
\input{lec11.tex}
% section Lecture 11: Resouce Theory and Entanglement Resource (end)

\newpage 
\section{Lecture 13: Entanglement Measure}\label{sec:Lecture 12: Entanglement Measure} % (fold)
\input{lec12.tex}
